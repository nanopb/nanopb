# Nanopb: New features in nanopb 0.4 and 1.0

## What's new in nanopb 1.0
...
Note that this does not apply to compatibility functions
`pb_make_string_substream` and `pb_close_string_substream` which still make
a full copy of the context structure.
