...
includes nanopb headers. For shared libraries, [ABI](https://en.wikipedia.org/wiki/Application_binary_interface) compatibility between nanopb versions is only tested for the fully-featured default configuration.
