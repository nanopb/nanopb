...
- [API reference](./reference.md)
  ...
  - [pb_common.h](./reference_pb_common_h.md)

# Build systems
- [PlatformIO](./build_platformio.md)
- [CMake](./build_cmake.md)
- [Makefiles](./build_makefile.md)
- [Bazel](./build_bazel.md)
- [Conan](./build_conan.md)
- [Swift](./build_swift.md)
