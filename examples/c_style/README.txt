Nanopb example "c_style"
=======================

This example demonstrates the very basic use of nanopb using C style generator.
...
run it with the command: ./c_style

On other platforms, you first have to compile the protocol definition using
the following command::

  ../../generator-bin/protoc --nanopb_out=-C:. c_style.proto

After that, add the following five files to your project and compile:

  c_style.c  c_style.pb.c  pb_encode.c  pb_decode.c  pb_common.c
