'''
Scons Builder for grpc services from nanopb .proto definitions.

This tool will locate the nanopb generator and use it to generate .ng.c and
.ng.h files from the .proto files.

Basic example
-------------
# Build myproto.ng.c and myproto.ng.h from myproto.proto
...
_nanogrpc_proto_builder = SCons.Builder.Builder(
    generator = _nanogrpc_proto_actions,
    suffix = '.ng.c',
    src_suffix = '.proto',
    emitter = _nanogrpc_proto_emitter)
