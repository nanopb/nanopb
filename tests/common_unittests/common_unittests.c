...
int main()
{
...

    {
        ...
        TEST(pb_field_iter_next(&iter) && iter.tag == 64 && iter.pData == &msg.oneof.callback_msg  && iter.pSize == &msg.which_oneof   )
        TEST(pb_field_iter_next(&iter) && iter.tag == 65 && iter.pData == &msg.oneof.oneof_msg_wcb  && iter.pSize == &msg.which_oneof   )
        TEST(pb_field_iter_next(&iter) && iter.tag == 66 && iter.pData == &msg.oneof.static_val  && iter.pSize == &msg.which_oneof   )
        TEST(pb_field_iter_next(&iter) && iter.tag == 67 && iter.pData == &msg.oneof.callback_val  && iter.pSize == &msg.which_oneof   )
        TEST(iter.required_field_index == 19)
