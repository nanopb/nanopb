...
#if PB_PROTO_HEADER_VERSION != 90
#error Regenerate this file with the current version of nanopb generator.
#endif

/* Enum definitions */
typedef enum _HugeEnum {
    HugeEnum_Negative = -2147483647, /* protoc doesn't accept -2147483648 here */
...
#define Limits_enum_min_ENUMTYPE HugeEnum
#define Limits_enum_max_ENUMTYPE HugeEnum

#define AllTypes_req_enum_ENUMTYPE MyEnum
#define AllTypes_rep_enum_ENUMTYPE MyEnum
#define AllTypes_opt_enum_ENUMTYPE MyEnum
...
#define SubMessage_DEFAULT (const pb_byte_t*)"\x0a\x01\x31\x10\x02\x1d\x03\x00\x00\x00\x00"
#define SubMessage_FLAGS (PB_MSGFLAG_R_HAS_DEFVAL)

#define EmptyMessage_FIELDLIST(X, a) \

#define EmptyMessage_CALLBACK NULL
#define EmptyMessage_DEFAULT NULL
#define EmptyMessage_FLAGS (0)
...
#define Limits_DEFAULT (const pb_byte_t*)""
#define Limits_FLAGS (PB_MSGFLAG_R_HAS_DEFVAL)
...
#define ALLTYPES_LEGACY_H_MAX_SIZE               AllTypes_size
