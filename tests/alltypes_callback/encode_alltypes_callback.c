...
static bool write_varint(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
           pb_encode_varint(stream, (intptr_t)*arg);
}

static bool write_svarint(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
           pb_encode_svarint(stream, (intptr_t)*arg);
}

static bool write_fixed32(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
           pb_encode_fixed32(stream, *arg);
}

static bool write_fixed64(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
           pb_encode_fixed64(stream, *arg);
}

static bool write_double(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
...
static bool write_submsg(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
...
static bool write_emptymsg(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
...
static bool write_repeated_varint(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
...
static bool write_repeated_svarint(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
...
static bool write_repeated_fixed32(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    uint32_t dummy = 0;
...
static bool write_repeated_fixed64(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    uint64_t dummy = 0;
...
static bool write_repeated_double(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    uint64_t dummy = 0;
...
static bool write_repeated_string(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    return pb_encode_tag_for_field(stream, field) &&
...
static bool write_repeated_submsg(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    SubMessage dummy = {""};
...
static bool write_limits(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    Limits limits = {0};
...
static bool write_ds8(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
...
static bool write_intsizes(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
...
static bool write_repeated_emptymsg(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    EmptyMessage emptymsg = {0};
    return pb_encode_tag_for_field(stream, field) &&
           pb_encode_submessage(stream, EmptyMessage_fields, &emptymsg) &&
...
static bool write_farray2(pb_encode_ctx_t *stream, const pb_field_iter_t *field, void * const *arg)
{
    uint32_t dummy = 0;
