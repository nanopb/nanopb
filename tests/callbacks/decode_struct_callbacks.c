...
bool print_fixed32(pb_decode_ctx_t *stream, const pb_field_iter_t *field, void **arg)
{
    uint32_t value;
...
bool print_fixed64(pb_decode_ctx_t *stream, const pb_field_iter_t *field, void **arg)
{
    uint64_t value;
