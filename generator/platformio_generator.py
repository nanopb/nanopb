...
nanopb_require_protoc = env.GetProjectOption("nanopb_require_protoc", "yes")

if nanopb_require_protoc.upper() == "NO" or nanopb_require_protoc.upper() == "FALSE":
    print(f"[nanopb] Don't use nanopb protoc step")
else:
    do_platformio_protoc()
