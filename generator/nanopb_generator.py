...
datatypes = {
    ...
    (FieldD.TYPE_FIXED32,   nanopb_pb2.IS_8):   ('uint8_t',  'FIXED32',  4,    1),
    (FieldD.TYPE_FIXED32,  nanopb_pb2.IS_16):   ('uint16_t', 'FIXED32',  4,    2),
    (FieldD.TYPE_FIXED32,  nanopb_pb2.IS_32):   ('uint32_t', 'FIXED32',  4,    4),
    (FieldD.TYPE_FIXED32,  nanopb_pb2.IS_64):   ('uint64_t', 'FIXED32',  8,    8),
    (FieldD.TYPE_SFIXED32,  nanopb_pb2.IS_8):   ('int8_t',  'SFIXED32',  4,    1),
    (FieldD.TYPE_SFIXED32, nanopb_pb2.IS_16):   ('int16_t', 'SFIXED32',  4,    2),
    (FieldD.TYPE_SFIXED32, nanopb_pb2.IS_32):   ('int32_t', 'SFIXED32',  4,    4),
    (FieldD.TYPE_SFIXED32, nanopb_pb2.IS_64):   ('int64_t', 'SFIXED32',  8,    8),
    ...
    (FieldD.TYPE_FIXED64,   nanopb_pb2.IS_8):   ('uint8_t',  'FIXED64',  8,    1),
    (FieldD.TYPE_FIXED64,  nanopb_pb2.IS_16):   ('uint16_t', 'FIXED64',  8,    2),
    (FieldD.TYPE_FIXED64,  nanopb_pb2.IS_32):   ('uint32_t', 'FIXED64',  8,    4),
    (FieldD.TYPE_FIXED64,  nanopb_pb2.IS_64):   ('uint64_t', 'FIXED64',  8,    8),
    (FieldD.TYPE_SFIXED64,  nanopb_pb2.IS_8):   ('int8_t',  'SFIXED64',  8,    1),
    (FieldD.TYPE_SFIXED64, nanopb_pb2.IS_16):   ('int16_t', 'SFIXED64',  8,    2),
    (FieldD.TYPE_SFIXED64, nanopb_pb2.IS_32):   ('int32_t', 'SFIXED64',  8,    4),
    (FieldD.TYPE_SFIXED64, nanopb_pb2.IS_64):   ('int64_t', 'SFIXED64',  8,    8),
}
